...
export function loadrespiratory() {
    ...
    createSphereBtn(0,0,0.025,function(){createBasicPopup("Bronchi","The bronchi are the two large tubes that carry air from the windpipe (trachea) into the lungs and back out again.", () => loadbronchi());},0.05);
